<template>
  <footer class="relative bg-gray-900 text-slate-300 pt-16 pb-6">
    <div
      ...
      style="
        background-image: url('https://images.unsplash.com/photo-1525307932909-fd14b501d8d3?w=1920&auto=format&fit=crop&q=80');
      "
    ></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="flex flex-col items-center md:items-start">
          <div class="flex items-center gap-3 mb-4">
            ...
            <span class="font-bold text-white text-xl">Cổng Sách Việt</span>
          </div>
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a
              href="https://www.facebook.com/share/1CqZNanxr5/"
      ...
      <div class="mt-8 text-center text-sm text-slate-400">
        <p>
          &copy; {{ new Date().getFullYear() }} Cổng Sách Việt by Nguyễn Công
          Chức.
        </p>
      </div>
    </div>
